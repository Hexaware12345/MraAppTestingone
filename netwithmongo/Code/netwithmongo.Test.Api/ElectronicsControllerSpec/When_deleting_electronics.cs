...
{
    public class When_deleting_electronics : UsingElectronicsControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _electronicsService.Delete(Id).Returns(true);
        }
        ...
        {
            _electronicsService.Received(1).Delete(Id);
