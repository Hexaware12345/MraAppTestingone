...
using netwithmongo.Api.Filters;
using netwithmongo.BusinessServices.Installer;

namespace netwithmongo.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "netwithmongo API", Version = version + "-" + branch});
            });
