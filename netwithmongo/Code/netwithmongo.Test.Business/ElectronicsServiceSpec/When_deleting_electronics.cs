...
{
    public class When_deleting_electronics : UsingElectronicsServiceSpec
    {
        ...
        public override void Context()
        {
            ...
            _electronicsRepository.Delete(Id).Returns(true);
        }
        ...
        {
            _electronicsRepository.Received(1).Delete(Id);
